...
class FakeProvider(Provider):
    def __init__(self, fake_backend, transpile_mode=0):
        super().__init__(transpile_mode)
...
class FakeQuebecProvider(FakeProvider):
    def __init__(self, transpile_mode=0):
        super().__init__(FakeQuebec, transpile_mode)