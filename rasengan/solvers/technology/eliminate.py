...
from rasengan.solvers.qiskit.provider import Provider
from rasengan.solvers.options import ModelOption
import numpy as np
...
class Eliminate_variables():
    ...
    def solve(self):
        ...
        for i in range(2**num_frozen_qubit):
            ...
            from rasengan.utils.linear_system import to_row_echelon_form
