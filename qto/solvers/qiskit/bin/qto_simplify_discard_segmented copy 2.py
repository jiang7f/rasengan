...
class QtoSDiscardSegmentedCircuit(QiskitCircuit[ChCircuitOption]):
...
class QtoSDiscardSegmentedSolver(Solver):
    def __init__(
        self,
        *,
        prb_model: LcboModel,
    ...
    def circuit(self):
        if self._circuit is None:
            self._circuit = QtoSDiscardSegmentedCircuit(self.circuit_option, self.model_option, self.hlist)
