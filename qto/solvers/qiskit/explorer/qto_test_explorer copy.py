...
class QtoTestExplorer(Explorer):
    ...
    def explore(self):
        ...
        for order in range(self.num_repetition):
            ...
            for idx, hdi in enumerate(self.model_option.Hd_bitstr_list):
                ...
                for state in state_list:
                    ...
                    if all(elem in [0, 1] for elem in new_state_add) and tuple(new_state_add) not in dict_state:
                    ...
                    if all(elem in [0, 1] for elem in new_state_sub) and tuple(new_state_sub) not in dict_state:
        ...
        return dict_state, max_order, counter
    ...
    # def plot_generation_relationship(self, node_size: int = 500, figsize: tuple[int, int] = (12, 8), use_absolute_position=False):
    #     dict_state = self.dict_state
    ...
    #     nx.draw(G, pos, labels=labels, node_color=colors, cmap=plt.cm.Blues, with_labels=True, node_size=node_size, font_size=10, font_color='black', edge_color='gray')
